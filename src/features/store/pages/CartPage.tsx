  ...
  return (
    <div className="min-h-screen bg-background pb-32">
      ...
      <div className="sticky top-0 z-40 bg-background/95 backdrop-blur border-b border-border">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <button
            ...
            className="p-2 hover:bg-secondary rounded-full transition-colors text-destructive"
          >
      ...
      <div className="px-4 py-4 space-y-4">
        {cartItems.map((item) => (
          <div key={item.productId} className="bg-card rounded-xl p-4 shadow-sm">
            <div className="flex gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <button
                  ...
                  className="flex items-center gap-1 mt-2 text-sm text-primary hover:text-primary/80"
                >
          ...
          <div className="bg-card rounded-xl p-6 w-full max-w-sm">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-3 bg-secondary rounded-lg font-medium hover:bg-secondary/80 transition-colors"
              >
                Cancel
              </button>
              <button
